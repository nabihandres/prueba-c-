...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/nabih/prueba/src/test)
  set(test_DEVEL_PREFIX /home/nabih/prueba/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/nabih/prueba/install)
...
if(NOT "/home/nabih/prueba/src/test/include;/usr/include/eigen3 " STREQUAL " ")
  set(test_INCLUDE_DIRS "")
  set(_include_dirs "/home/nabih/prueba/src/test/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nabih/prueba/src/test/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nabih/prueba/devel/lib;/opt/ros/melodic/lib)
